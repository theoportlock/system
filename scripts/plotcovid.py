...
df_covid_2019.dateRep = pd.to_datetime(df_covid_2019.dateRep, format='%d/%m/%Y')
df_covid_2019 = df_covid_2019.dropna()
country_df = df_covid_2019.loc[df_covid_2019.countriesAndTerritories == 'United_Kingdom'][::-1]
...
popt, pcov = np.polyfit(pd.to_numeric(x1), y1, 4, cov=True)
